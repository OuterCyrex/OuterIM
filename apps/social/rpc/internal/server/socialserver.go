...
import (
	...
	"OuterIM/apps/social/rpc/internal/logic"
...
func (s *SocialServer) FriendPutInList(ctx context.Context, in *social.FriendListReq) (*social.FriendListResp, error) {
...
func (s *SocialServer) GroupPutInList(ctx context.Context, in *social.GroupPutinListReq) (*social.GroupPutinResp, error) {
