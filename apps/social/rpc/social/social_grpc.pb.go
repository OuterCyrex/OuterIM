...
type SocialClient interface {
	...
	FriendPutInList(ctx context.Context, in *FriendListReq, opts ...grpc.CallOption) (*FriendListResp, error)
	...
	GroupPutInList(ctx context.Context, in *GroupPutinListReq, opts ...grpc.CallOption) (*GroupPutinResp, error)
...
func (c *socialClient) FriendPutInList(ctx context.Context, in *FriendListReq, opts ...grpc.CallOption) (*FriendListResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *socialClient) GroupPutInList(ctx context.Context, in *GroupPutinListReq, opts ...grpc.CallOption) (*GroupPutinResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GroupPutinResp)
...
type SocialServer interface {
	...
	FriendPutInList(context.Context, *FriendListReq) (*FriendListResp, error)
	...
	GroupPutInList(context.Context, *GroupPutinListReq) (*GroupPutinResp, error)
...
func (UnimplementedSocialServer) FriendPutInList(context.Context, *FriendListReq) (*FriendListResp, error) {
...
func (UnimplementedSocialServer) GroupPutInList(context.Context, *GroupPutinListReq) (*GroupPutinResp, error) {
...
func _Social_FriendPutInList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SocialServer).FriendPutInList(ctx, req.(*FriendListReq))
	}
	return interceptor(ctx, in, info, handler)
}
