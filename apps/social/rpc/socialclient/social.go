...
func (m *defaultSocial) FriendPutInList(ctx context.Context, in *FriendListReq, opts ...grpc.CallOption) (*FriendListResp, error) {
	client := social.NewSocialClient(m.cli.Conn())
...
func (m *defaultSocial) GroupPutInList(ctx context.Context, in *GroupPutinListReq, opts ...grpc.CallOption) (*GroupPutinResp, error) {
	client := social.NewSocialClient(m.cli.Conn())
